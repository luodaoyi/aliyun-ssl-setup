...
EVENTS = [
    ...
    (0.34, "cas", "CAS 证书管家", "解析证书 5/11：cert-example01", 5, 11, "info"),
    (0.36, "cas", "CAS 证书管家", "解析证书 10/11：cert-example02", 10, 11, "info"),
...
window.go = { main: { App: {
  GetConfig: async () => ({ access_key_id: "LTAI5tExampleAccessKeyId", access_key_secret: "***",
